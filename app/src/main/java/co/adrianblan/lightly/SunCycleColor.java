...
public class SunCycleColor {
    ...
    public int getOverlayColor(int colorIntensity, int brightnessIntensity) {
    ...
    private int interpolate (int color1, int color2, int colorIntensity, int brightnessIntensity) {
